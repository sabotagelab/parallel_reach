...
class MPCKinematicNode:
    def __init__(self):
        ...
        self.param = {'dT': rospy.get_param('dT', 0.2),
                      ...
                      'mpc_w_cte': rospy.get_param('mpc_w_cte', 50), #50
                      'mpc_w_epsi': rospy.get_param('mpc_w_epsi', 50),
                      'mpc_w_s': rospy.get_param('mpc_w_s', 0),
                      'mpc_w_lag': rospy.get_param('mpc_w_lag', 800),  #1000
                      'mpc_w_vel': rospy.get_param('mpc_w_vel', 0.001),
                      'mpc_w_delta': rospy.get_param('mpc_w_delta', 50),
                      'mpc_w_p': rospy.get_param('mpc_w_p', 20),  #30
                      'mpc_w_accel': rospy.get_param('mpc_w_accel', 1),
