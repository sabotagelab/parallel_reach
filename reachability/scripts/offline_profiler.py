...
steps_list = list(range(min_steps, max_steps, 2))
...
all_modes_trials = [200, 200, 200, 200, 20]
#all_modes_trials = [20, 20, 20, 20, 1]
...
cutoff_modes = set()
cutoff_time = 1.5 #we only run a few trials for modes over this
cutoff_trials = 5 #run way fewer trials once timout is reached
